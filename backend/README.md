...
## Project Structure
    ...
    ├── testapiautoconnect_117350  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_117350`
...
2. Clone this repo and `cd testapiautoconnect_117350`
